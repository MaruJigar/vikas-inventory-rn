...
import { DistributorDashboardScreen } from './src/screens/DistributorDashboardScreen';
...
import { UserApprovalsScreen } from './src/screens/UserApprovalsScreen';
...
// Distributor: Orders, Inventory, Team
const DistributorNavigator = () => (
  <Stack.Navigator screenOptions={screenOptions}>
    <Stack.Screen name="DistributorDashboard" component={DistributorDashboardScreen} />
    <Stack.Screen name="OrderHistory" component={OrderHistoryScreen} />
    <Stack.Screen name="OrderDetails" component={OrderDetailsScreen} />
    ...
    <WebResponsiveWrapper>
      <NavigationContainer>
        <Stack.Navigator screenOptions={screenOptions}>
          ...
          ) : appState.userRole === 'distributor' ? (
            <Stack.Screen name="DistributorStack" component={DistributorNavigator} />
          ) : (
