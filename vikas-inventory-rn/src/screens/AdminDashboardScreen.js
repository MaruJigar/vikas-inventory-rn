      ...
      <ScrollView showsVerticalScrollIndicator={false} style={{ flex: 1 }}>
        ...
        <View style={styles.content}>
          ...
          <TouchableOpacity
            ...
            activeOpacity={0.7}
          >
            <View style={[styles.mgmtIcon, { backgroundColor: '#FFFBEB' }]}>
              <Feather name="user-check" size={20} color={COLORS.warning} />
            </View>
            <View style={styles.mgmtInfo}>
              <Text style={styles.mgmtTitle}>User Approvals</Text>
              <Text style={styles.mgmtSubtitle}>Approve pending distributors & salesmen</Text>
            </View>
            <Feather name="chevron-right" size={18} color={COLORS.gray400} />
          </TouchableOpacity>
