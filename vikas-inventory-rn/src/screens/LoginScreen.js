...
export const LoginScreen = ({ navigation }) => {
  ...
  const handleLoginPress = () => {
    ...
    // Simulate API delay
    setTimeout(() => {
      if (handleLogin(phone.trim(), password)) {
        setPhone('');
        setPassword('');
      } else {
        ...
        <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
          ...
          <View style={styles.loginCard}>
            ...
            <View style={styles.inputGroup}>
              ...
              <View style={[styles.inputWrap, error && !phone && styles.inputError]}>
          ...
          <View style={styles.demoSection}>
            ...
            <View style={styles.demoRow}>
              <TouchableOpacity
                ...
                onPress={() => { handleLogin('9876543210', 'salesman123'); }}
              >
              ...
              <TouchableOpacity
                ...
                onPress={() => { handleLogin('9999999999', 'admin123'); }}
              >
                <Text style={styles.demoBtnIcon}>👨‍💼</Text>
