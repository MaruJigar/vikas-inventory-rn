...
export const en = {
  ...
  inventory: {
    ...
    emptyHint: 'Add opening stock for a product to start tracking it.',
    noResults: 'No products match your search.',
    loadError: 'Could not load your inventory.',
    filterAll: 'All',
    sort: {
    ...
    detail: {
      ...
      noMovementsFiltered: 'No movements of this type.',
    ...
    adjust: {
      ...
      action: 'Adjust stock',
      product: 'Product',
      pickProduct: 'Choose the product to adjust.',
      change: 'Change',
      type: 'Movement type',
      qtyAdd: 'Quantity to add',
      qtyRemove: 'Quantity to remove',
      reason: 'Reason (optional)',
      reasonPlaceholder: 'e.g. damaged in transit, stock count correction',
      preview: 'Available will change from {{from}} to {{to}}.',
      submit: 'Save adjustment',
      success: 'Stock updated.',
      invalidQty: 'Enter a quantity of at least 1.',
      tooMany: 'You only have {{max}} available.',
      notOwnProduct:
        'You can only adjust stock for your own products. Manufacturer products are stocked through orders.',
      noOwnProducts: 'You have no products of your own yet.',
      ownProductsNote:
        'Only products you created can be adjusted by hand — manufacturer stock moves through the order flow.',
    },
    valuation: {
      title: 'Stock value',
      hint: 'What your stock on hand is worth',
      totalLabel: 'Total stock value',
      atMrp: 'Valued at MRP',
      breakdown: '{{qty}} available × {{mrp}}',
      empty: 'Nothing to value yet',
      emptyHint: 'Products with stock on hand will appear here.',
      loadError: 'Could not load the stock value report.',
    },
  },
  account: {
    title: 'Account',
  ...
  categories: {
    ...
    addError: 'Could not add the category.',
  },
  products: {
    quantity: 'Quantity',
    title: 'Products',
    ...
    details: {
      ...
      priceNote: 'Your price per unit (before GST)',
      mrp: 'MRP',
    ...
    form: {
      ...
      description: 'Description',
      category: 'Category',
      noCategories: 'No categories yet — add one from All Categories.',
      categoryFixed: 'Adding to {{name}}. Go back to All Categories to add to a different one.',
  ...
  validation: {
    ...
    maxLength20: 'Use at most 20 characters',
  },
  errors: {
