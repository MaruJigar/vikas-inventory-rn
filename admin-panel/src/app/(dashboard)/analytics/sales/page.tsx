      ...
      <AppLayout>
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <Link href="/analytics/sales/sales-summary" className="group">
              <div className="p-6 bg-white border rounded-lg shadow-sm hover:shadow-md transition-shadow h-full flex flex-col">
                <div className="flex items-center space-x-3 mb-3">
                  ...
                  <h2 className="text-lg font-semibold text-gray-900 group-hover:text-blue-600 transition-colors">Sales Summary</h2>
                </div>
                <p className="text-sm text-gray-500 flex-1">
                  View aggregated product sales revenue and quantities over time.
                </p>
