...
import { SalesmanDto, RegisterSalesmanDto, UpdateSalesmanDto, UpdateSalesmanStatusDto } from '@/types/api/salesman.types';
...
export const salesmanService = {
  ...
  updateSalesmanStatus: (id: string, data: UpdateSalesmanStatusDto) => api.patch<ApiResponse<{ message: string }>>(`/salesmen/${id}/status`, data).then(res => res.data),
};
