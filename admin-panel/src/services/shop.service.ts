...
import { ShopDto, ManufacturerShopDto, CreateShopDto, UpdateShopDto, CheckDuplicateDto } from '@/types/api/shop.types';
...
export const shopService = {
  ...
  getManufacturerShops: (params?: QueryParams) => api.get<PaginatedResponse<ManufacturerShopDto>>('/shops/manufacturer', { params }).then(res => res.data),
