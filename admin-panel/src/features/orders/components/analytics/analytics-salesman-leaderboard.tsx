...
interface AnalyticsSalesmanLeaderboardProps {
  data: OrdersAnalyticsLeaderboardItem[] | undefined;
  isLoading: boolean;
}

export function AnalyticsSalesmanLeaderboard({ data, isLoading }: AnalyticsSalesmanLeaderboardProps) {
  return (
    <Card>
      <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-4">
        <CardTitle className="text-base font-semibold">Top Salesmen</CardTitle>
