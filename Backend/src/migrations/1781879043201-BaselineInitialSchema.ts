...
export class BaselineInitialSchema1781879043201 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "product_price_history" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "product_id" uuid NOT NULL, "old_mrp" numeric(12,2), "new_mrp" numeric(12,2), "old_gst_percent" numeric(5,2), "new_gst_percent" numeric(5,2), "old_distributor_discount_percent" numeric(5,2), "new_distributor_discount_percent" numeric(5,2), "old_special_discount_percent" numeric(5,2), "new_special_discount_percent" numeric(5,2), "changed_by_user_id" uuid, "reason" text, "created_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_8ad05105010c053126d79113a5c" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "permissions" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "key" character varying(150) NOT NULL, "description" text, "created_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_017943867ed5ceef9c03edd9745" UNIQUE ("key"), CONSTRAINT "PK_920331560282b8bd21bb02290df" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "role_permissions" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "role_id" uuid, "permission_id" uuid, "created_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_25d24010f53bb80b78e412c9656" UNIQUE ("role_id", "permission_id"), CONSTRAINT "PK_84059017c90bfcb701b8fa42297" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "roles" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying(80) NOT NULL, "description" text, "created_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_648e3f5447f725579d7d4ffdfb7" UNIQUE ("name"), CONSTRAINT "PK_c1433d71a4838793a49dcad46ab" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "shop_duplicate_logs" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "distributor_id" uuid, "attempted_shop_name" character varying(200), "attempted_phone" character varying(30), "attempted_location" geography(Point,4326), "matched_shop_id" uuid, "match_type" character varying(50), "match_score" numeric(5,2), "action_taken" character varying(50), "created_by_user_id" uuid, "created_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_c6bf4601681bf93615dae0fc371" PRIMARY KEY ("id"))`);
