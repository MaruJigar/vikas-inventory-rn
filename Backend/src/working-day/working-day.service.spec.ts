...
describe('WorkingDayService', () => {
    ...
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        WorkingDayService,
        {
          ...
          useValue: mockWorkingDayRepository,
        },
        {
        ...
        },
        {
          ...
          useValue: mockLatestLocationRepository,
        },
        {
          provide: getRepositoryToken(Salesman),
          useValue: mockSalesmanRepository,
        },
        {
  ...
  describe('checkIn', () => {
    it('Check-In Success: Should check in a valid salesman', async () => {
      mockSalesmanRepository.findOne.mockResolvedValue({
        id: 's1',
        user_id: 'u1',
        distributor_id: 'd1',
        approval_status: 'APPROVED',
      });
      mockDistributorRepository.findOne.mockResolvedValue({
        id: 'd1',
        user_id: 'du1',
        status: 'ACTIVE',
      });
    ...
    it('Check-In Failure: Should reject pending salesman', async () => {
      ...
      await expect(
        service.checkIn('u1', { latitude: 10, longitude: 20 }),
    ...
    it('Check-In Idempotency: Should return existing record without saving', async () => {
      mockWorkingDayRepository.findOne.mockResolvedValue({
        id: 'wd1',
  ...
  describe('checkOut', () => {
    ...
    it('Check-Out Failure: Should reject without active working day', async () => {
      ...
      await expect(
        service.checkOut('u1', { latitude: 10, longitude: 20 }),
